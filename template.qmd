...
reticulate::use_condaenv("quartoWBtheme")
```
...
# The Basics! {background-color="#002244"}
...
# Advanced Layouts! {background-color="#002244" background-opacity="0.8"}
...
title <- "<span style='font-family:Arial;font-size:10pt;'>**Washington, DC**</span><br><br>
<span style='font-size:4pt;'>Map of <span style='font-size:5pt; color:#D1BE9C'>University Campuses</span> and <span style='font-size:5pt; color:#EBB9DF'>Cafes</span> in<br> Washington, DC according to OSM data.</span>"
...
```{r echo=TRUE, width = 40, height = 20}
...
# Present and Share your Presentation with the World! {background-color="#002244"}
