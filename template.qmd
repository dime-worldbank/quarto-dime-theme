...
format:
  dime-revealjs:
    ...
    footer: "[DIME](https://github.com/worldbank) theme for [Quarto Presentations](https://quarto.org/docs/presentations/revealjs/index.html). Code available on [GitHub](https://github.com/BBieri/quartodimetheme)."
---
...
source("_extensions/BBieri/dime/setup_dime_palettes.R")
source("_extensions/BBieri/dime/setup_ggplot2_dime.R")
