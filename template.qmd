...
## Creating interactive graphs with Observable JS {.scrollable}
...
```{ojs}
// Import data
inst1 = JSONstat("https://api.worldbank.org/v2/country/all/indicator/NY.GDP.PCAP.CD?mrv=15&format=jsonstat")
ds1 = inst1.Dataset(0)
obj1 = ds1.toTable({ type: "arrobj", field: "label", vlabel: "VALUE" })
Inputs.table(obj1)
```
